...
const coreConcepts = [
  {
    ...
    text: "Bitcoin arbitrage is best framed as a workflow that tracks pricing differences across exchanges, pairs, and liquidity conditions in real time.",
  },
  {
    icon: Route,
    title: "Execution Path Efficiency",
    text: "A strong Bitcoin arbitrage page should emphasize route selection, timing, fee awareness, and efficient execution logic to support more competitive trades.",
  },
  {
    icon: CandlestickChart,
    title: "Spread Analysis & Validation",
    text: "The product story should focus on identifying price spreads, validating opportunity quality, and filtering weak setups before execution is attempted.",
  },
];
...
const steps = [
  {
    ...
    text: "Begin through a clean onboarding flow that prepares the interface for Bitcoin-focused arbitrage monitoring and execution workflows.",
  },
  {
    number: "02",
    icon: Settings2,
...
const features = [
  {
    icon: Layers3,
    title: "Bitcoin Arbitrage Strategies",
    text: "Deploy Bitcoin-focused arbitrage workflows through a structured interface built for visibility, organization, and professional execution control.",
  },
  {
    icon: Radar,
...
const faqs = [
  {
    q: "What is Bitcoin arbitrage software?",
    a: "Bitcoin arbitrage software is generally described as a tool that monitors price differences across trading environments and attempts to execute profitable opportunities through automated or semi-automated workflows.",
  },
  {
    q: "How does Bitcoin arbitrage work?",
    a: "Bitcoin arbitrage involves buying Bitcoin where the price is lower and selling it where the price is higher. The spread, minus fees and execution costs, represents the potential profit.",
  },
  {
    q: "Why is Bitcoin often associated with arbitrage discussions?",
    a: "Bitcoin is one of the most actively traded digital assets in the market, which makes it a common environment for price-difference and spread-based trading discussions.",
  },
  {
...
export default function BitcoinArbitragePage() {
  return (
    <main className="min-h-screen bg-[#06080F] text-slate-100">
        ...
        <div className="section-shell relative">
          <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              >
                Advanced Bitcoin Arbitrage Software
              </motion.h1>

              <p className="mt-6 max-w-2xl text-base leading-8 text-slate-400 sm:text-lg">
                A premium fintech landing page for Bitcoin arbitrage workflows,
                  ...
                  <div className="space-y-5 p-6">
                    <div className="rounded-3xl border border-white/5 bg-black/40 p-5">
                      <div className="space-y-3 font-mono text-xs text-[#10B981]">
                        ...
                        <div>{">"} fee-aware execution filter synced</div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                      <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-4">
                        <Bitcoin className="mb-3 h-5 w-5 text-[#10B981]" />
                        <div className="text-sm font-medium text-white">BTC</div>
                        <div className="mt-1 text-xs leading-6 text-slate-500">
                          Built around Bitcoin price spread monitoring.
                        </div>
                      </div>
                      <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-4">
                        ...
                        <div className="mt-1 text-xs leading-6 text-slate-500">
                          Structured around efficient execution paths.
                        </div>
                      </div>
                      <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-4">
        ...
        <div className="section-shell">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] text-white sm:text-5xl">
              How the Bitcoin arbitrage narrative is framed
            </h2>
            <p className="mt-5 text-base leading-8 text-slate-400">
              This page presents Bitcoin arbitrage as buying where price is lower,
              selling where price is higher, and managing execution efficiency,
              fees, and spread quality through a structured workflow.
            </p>
          </div>
      ...
      <section id="bitcoin-features" className="py-20">
        <div className="section-shell">
          <div className="mx-auto max-w-3xl text-center">
            <div className="text-sm font-semibold uppercase tracking-[0.25em] text-[#10B981]">
              Core Features
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] text-white sm:text-5xl">
              Professional tools for Bitcoin arbitrage operators
            </h2>
            <p className="mt-5 text-base leading-8 text-slate-400">
            ...
            <div className="grid gap-0 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="border-b border-white/10 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10 xl:p-12">
                ...
                <p className="mt-6 max-w-md text-base leading-8 text-slate-400">
                  Get answers to common questions about Bitcoin arbitrage
