...
const coreConcepts = [
  {
    icon: Network,
    title: "Multi-Venue Opportunity Discovery",
    text: "Ethereum arbitrage is best presented as a workflow that monitors pricing differences across supported venues and liquidity environments in real time.",
  },
  {
    icon: Route,
    title: "Execution Path Optimization",
    text: "The product narrative should emphasize route selection, timing, and transaction efficiency to support more competitive arbitrage execution.",
  },
  {
    icon: Funnel,
    title: "Spread Analysis & Filtering",
    text: "A professional Ethereum arbitrage page should frame the strategy around identifying spreads, validating opportunity quality, and filtering out weak setups before execution.",
  },
];
...
const steps = [
  {
    ...
    text: "Begin through a clean onboarding flow that securely prepares the trading interface for Ethereum-focused arbitrage monitoring and execution.",
  },
  {
    number: "02",
    icon: Settings2,
    title: "Configure Arbitrage Settings",
    text: "Set your preferred execution profile, review strategy parameters, and prepare the environment through a polished operator dashboard.",
  },
  {
    number: "03",
    icon: Activity,
    title: "Deploy & Monitor",
    text: "Launch the workflow and follow live analytics, transaction activity, and strategy performance through a modern fintech-style control surface.",
  },
];
...
const features = [
  {
    icon: Layers3,
    title: "Ethereum Arbitrage Strategies",
    text: "Deploy advanced Ethereum arbitrage workflows through a refined interface built for visibility, structure, and professional execution control.",
  },
  {
    icon: Radar,
    title: "Real-Time Market Analysis",
    text: "Track live price movement, spread formation, and execution-sensitive conditions with a clean professional analytics experience.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    text: "Analyze execution behavior, inspect trading outcomes, and review key performance metrics through a polished dashboard interface.",
  },
  {
    icon: Server,
  ...
  },
  {
    ...
    text: "This page is positioned around a non-custodial workflow concept where the user retains direct control of wallet access and setup.",
  },
];

const faqs = [
  {
    q: "What is Ethereum arbitrage trading software?",
    a: "Ethereum arbitrage software is generally described as a tool that monitors price differences across trading environments and attempts to execute profitable opportunities through automated or semi-automated workflows.",
  },
  {
    q: "Why is Ethereum commonly used for arbitrage strategies?",
    a: "Ethereum remains one of the most active blockchain ecosystems for trading, liquidity, and DeFi activity, which makes it a common environment for arbitrage-focused product positioning.",
  },
  {
    q: "Do I need coding experience to use the platform?",
    a: "Not necessarily. A strong interface can make advanced workflows easier to operate through a guided dashboard experience, even when the underlying strategy is sophisticated.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Any trading-related result depends on market conditions, spread quality, competition, gas costs, latency, infrastructure, and risk settings.",
  },
  {
    q: "Can this page be extended later with pricing or onboarding?",
    a: "Yes. It follows the same product-page architecture as the other pages, so pricing, onboarding, and plan sections can be added later without redesigning the whole experience.",
  },
];

export default function EthereumArbitragePage() {
  return (
    <main className="min-h-screen bg-[#06080F] text-slate-100">
        ...
        <div className="section-shell relative">
          <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              >
                Advanced Ethereum Arbitrage Software
              </motion.h1>

              <p className="mt-6 max-w-2xl text-base leading-8 text-slate-400 sm:text-lg">
                A premium fintech landing page for Ethereum arbitrage workflows,
                designed around spread analysis, route optimization, real-time
                market monitoring, and professional trading visibility.
              </p>
              ...
              <div className="mt-10 flex flex-wrap gap-8">
                ...
                <div>
                  ...
                  <div className="mt-1 text-sm text-slate-500">Route optimization</div>
                </div>
                <div>
                  ...
                  <div className="space-y-5 p-6">
                    <div className="rounded-3xl border border-white/5 bg-black/40 p-5">
                      <div className="space-y-3 font-mono text-xs text-[#10B981]">
                        ...
                        <div>{">"} gas-aware execution filter synced</div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                      ...
                      <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-4">
                        ...
                        <div className="mt-1 text-xs leading-6 text-slate-500">
                          Structured around execution path selection.
                        </div>
                      </div>
                      <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-4">
        ...
        <div className="section-shell">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] text-white sm:text-5xl">
              How the Ethereum arbitrage narrative is framed
            </h2>
            <p className="mt-5 text-base leading-8 text-slate-400">
              Ethereum arbitrage is commonly positioned around real-time market
              analysis, route selection, spread validation, risk management,
              performance dashboards, and non-custodial wallet control.
            </p>
          </div>
        ...
        <div className="section-shell">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-8 text-slate-400">
              ...
              used throughout your growing product-page system.
            </p>
          </div>
      ...
      <section id="ethereum-features" className="py-20">
        <div className="section-shell">
          <div className="mx-auto max-w-3xl text-center">
            <div className="text-sm font-semibold uppercase tracking-[0.25em] text-[#10B981]">
              Core Features
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] text-white sm:text-5xl">
              Professional tools for Ethereum arbitrage operators
            </h2>
            <p className="mt-5 text-base leading-8 text-slate-400">
            ...
            <div className="grid gap-0 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="border-b border-white/10 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10 xl:p-12">
                ...
                <p className="mt-6 max-w-md text-base leading-8 text-slate-400">
                  Get answers to common questions about Ethereum arbitrage
          ...
          <div className="rounded-[36px] border border-[#10B981]/20 bg-[linear-gradient(180deg,rgba(16,185,129,0.14),rgba(16,185,129,0.03))] px-6 py-10 sm:px-10 sm:py-14">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 text-base leading-8 text-slate-300">
                ...
                Solana, Front Run, and Sandwich pages so the whole site stays cohesive.
              </p>

              <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <WalletModalPlaceholder trigger={<Button size="xl">Get Started</Button>} />
                <Link href="/sandwich-bot">
                  <Button variant="secondary" size="xl">
                    View Sandwich Page
                  </Button>
                </Link>
