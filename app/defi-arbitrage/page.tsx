...
const coreConcepts = [
  {
    icon: Network,
    title: "Multi-Chain Opportunity Discovery",
    text: "DeFi arbitrage is best framed as a workflow that monitors opportunities across multiple chains, venues, and liquidity environments in real time.",
  },
  {
    icon: Route,
    title: "Cross-Protocol Execution Paths",
    text: "A strong DeFi arbitrage page should emphasize route selection, protocol awareness, and efficient execution logic across decentralized environments.",
  },
  {
    icon: ScanSearch,
    title: "Spread Analysis & Validation",
    text: "The product narrative should focus on identifying pricing inefficiencies, validating trade quality, and filtering weaker setups before execution is attempted.",
  },
];
...
const steps = [
  {
    ...
    text: "Begin through a clean onboarding flow that prepares the interface for DeFi-focused arbitrage monitoring and execution workflows.",
  },
  {
    number: "02",
    icon: Settings2,
    title: "Configure Arbitrage Settings",
    text: "Adjust your execution preferences, review spread conditions, and prepare the trading environment through a refined dashboard experience.",
  },
  {
    number: "03",
    icon: Activity,
...
const features = [
  {
    ...
    text: "Deploy DeFi-focused arbitrage workflows through a structured interface built for visibility, organization, and professional execution control.",
  },
  {
    icon: Radar,
    title: "Real-Time Market Analysis",
    text: "Track live price movement, spread formation, and execution-sensitive market conditions with a professional analytics experience.",
  },
  {
    icon: ShieldCheck,
...
const faqs = [
  {
    q: "What is DeFi arbitrage software?",
    a: "DeFi arbitrage software is generally described as a tool that monitors pricing differences across decentralized protocols and attempts to execute profitable opportunities through automated or semi-automated workflows.",
  },
  {
    q: "Why is DeFi often associated with arbitrage opportunities?",
    a: "DeFi markets span multiple protocols, chains, and liquidity pools, which can create pricing inefficiencies and route-based opportunities that structured software can monitor.",
  },
  {
    q: "Does DeFi arbitrage only happen on one blockchain?",
    a: "No. A common product positioning for DeFi arbitrage is multi-chain capability, where opportunities may be monitored across Ethereum, Solana, Polygon, Avalanche, and other ecosystems.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Outcomes depend on spread quality, chain conditions, timing, fees, competition, infrastructure, and overall risk settings.",
  },
];
...
export default function DefiArbitragePage() {
  return (
    <main className="min-h-screen bg-[#06080F] text-slate-100">
        ...
        <div className="section-shell relative">
          <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              >
                Advanced DeFi Arbitrage Software
              </motion.h1>

              <p className="mt-6 max-w-2xl text-base leading-8 text-slate-400 sm:text-lg">
                A premium fintech landing page for DeFi arbitrage workflows,
                designed around multi-chain monitoring, cross-protocol execution,
                and professional visibility into decentralized market opportunities.
              </p>
              ...
              <div className="mt-10 flex flex-wrap gap-8">
                <div>
                  ...
                  <div className="mt-1 text-sm text-slate-500">Cross-ecosystem coverage</div>
                </div>
                <div>
                  <div className="text-2xl font-semibold text-white">Smart</div>
                  <div className="mt-1 text-sm text-slate-500">Cross-protocol routing</div>
                </div>
                <div>
                  ...
                  <div className="space-y-5 p-6">
                    <div className="rounded-3xl border border-white/5 bg-black/40 p-5">
                      <div className="space-y-3 font-mono text-xs text-[#10B981]">
                        <div>{">"} multi-chain scanner initialized</div>
                        <div>{">"} cross-protocol route engine online</div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                      <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-4">
                        ...
                        <div className="text-sm font-medium text-white">Chains</div>
                        <div className="mt-1 text-xs leading-6 text-slate-500">
                          Built around multi-chain opportunity discovery.
                        </div>
                      </div>
                      <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-4">
                        ...
                        <div className="mt-1 text-xs leading-6 text-slate-500">
                          Structured around cross-protocol execution paths.
                        </div>
                      </div>
                      <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-4">
        ...
        <div className="section-shell">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] text-white sm:text-5xl">
              How the DeFi arbitrage narrative is framed
            </h2>
            <p className="mt-5 text-base leading-8 text-slate-400">
              This page positions DeFi arbitrage around multi-chain opportunity discovery,
              cross-protocol routing, and spread validation across decentralized markets.
            </p>
          </div>
      ...
      <section id="defi-features" className="py-20">
        <div className="section-shell">
          <div className="mx-auto max-w-3xl text-center">
            <div className="text-sm font-semibold uppercase tracking-[0.25em] text-[#10B981]">
              Core Features
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] text-white sm:text-5xl">
              Professional tools for DeFi arbitrage operators
            </h2>
            <p className="mt-5 text-base leading-8 text-slate-400">
            ...
            <div className="grid gap-0 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="border-b border-white/10 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10 xl:p-12">
                ...
                <p className="mt-6 max-w-md text-base leading-8 text-slate-400">
                  Get answers to common questions about DeFi arbitrage
